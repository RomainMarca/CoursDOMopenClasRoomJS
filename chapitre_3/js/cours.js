...
//exercice 
let paraText1 = "En voici la ";
let paraText2 = " plus complète."
let para = document.createElement("p");
let link = document.createElement("a");
link.href = "https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation";
link.textContent = "liste";

para.appendChild(document.createTextNode(paraText1));
para.appendChild(link);
para.appendChild(document.createTextNode(paraText2));
