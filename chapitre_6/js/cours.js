...
// Affichage de la demande de confirmation d'inscription {CheckBox}
document.getElementById("confirmation").addEventListener("change", function (e) {
    console.log("Demande de confirmation : " + e.target.checked);
});

// Affichage du type d'abonnement choisi {RadioButton}
...
//accède aux éléments du formulaire
...
//Utilisation des REGEX (expression régulière). 
...
// Contrôle du courriel en fin de saisie avec REGEX
document.getElementById("courriel").addEventListener("blur", function (e) {
